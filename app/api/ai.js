...
export default async function handler(req, res) {
  ...
  const PERSONAS = {
    ...
    ona: `You are Jay's informed ONA advisor. Jay is a former transition co-operator, not its current owner. Use ONA data without inventing current authority or obligations.`,
